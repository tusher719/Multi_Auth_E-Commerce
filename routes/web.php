...
Route::prefix('category')->group(function (){
    ...
    Route::get('/sub/category/{id}', [SubCategoryController::class, 'SubCategoryEdit'])->name('subcategory.edit');
    ...
    Route::get('/sub/sub/category/{id}', [SubSubCategoryController::class, 'SubSubCategoryEdit'])->name('subsubcategory.edit');
...
Route::get('/language/hindi', [LanguageController::class, 'Bangla'])->name('bangla.language');
...
// WishList Remove Product with Ajax
