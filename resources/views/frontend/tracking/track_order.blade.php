    ...
    <article class="card">
        <div class="card-body">
            ...
            <div class="row" style="margin-left: 30px; margin-top: 20px;">
                ...
                <div class="col-md-8">
                    <h5>
                        <strong>Shipping By : </strong>{{ $track->name }} <br>
                    </h5>
                    <h5>
                        <strong>Location : </strong>{{ $track->state->state_name }}, {{ $track->division->division_name }}, {{ $track->district->district_name }}
                    </h5>
                ...
                <div class="col-md-4">
                    <h5>
                        <strong>Payment Method : </strong> {{ $track->payment_method  }}
                    </h5>
                ...
                <div class="col-md-4">
                    <h5>
                        <strong> Total Amount : </strong>$ {{ number_format($track->amount,2)  }}
                    </h5>
                </div> <!-- // end col md 2 -->
