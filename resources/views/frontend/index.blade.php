                            ...
                            <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                                ...
                                <div class="item">
                                    <div class="products special-product">
                                        ...
                                        @foreach($speciel_offer as $product)
                                            <div class="product">
                                                ...
                                                <div class="row product-micro-row">
                                                    ...
                                                    <div class="col col-xs-7">
                                                        <div class="product-info">
                                                            ...
                                                            @else
                                                                <div class="product-price"> <span class="price"> ৳{{ number_format($product->discount_price) }} </span> </div>
                                                            @endif
                                                            <!-- /.product-price -->
                            ...
                            <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                                ...
                                <div class="item">
                                    <div class="products special-product">
                                        ...
                                        @foreach($speciel_deals as $product)
                                            <div class="product">
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
...
{{--                                <li><a data-transition-type="backSlide" href="#apple" data-toggle="tab">Shoes</a></li>--}}
                                        ...
                                        <div class="product">
                                            ...
                                            <div class="product-info text-left">
                                                ...
                                                @if($product->discount_price == NULL)
                                                    <div class="product-price"> <span class="price"> ৳{{ number_format($product->selling_price) }} </span> </div>
                                                @else
                                                    <div class="product-price"> <span class="price"> ৳{{ number_format($product->discount_price) }} </span>
                                                        <span class="price-before-discount"> ৳ {{ number_format($product->selling_price) }}</span> </div>
                                            @endif
                                            <!-- /.product-price -->
                    ...
                    <!-- /.section -->
                    <!-- ========== Skip_category_2 PRODUCTS : END ========== -->


                    <!-- ========== Skip_category_3 PRODUCTS Start ========== -->
                    <section class="section featured-product wow fadeInUp">
                        <h3 class="section-title">
                            @if(session()->get('language') == 'bangla') {{ $skip_category_3->category_name_ban }} @else {{ $skip_category_3->category_name_en }} @endif
                        </h3>
                        <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
