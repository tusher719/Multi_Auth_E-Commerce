    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                ...
                <li><a href="#" title="@if(session()->get('language') == 'bangla') {{ $blogpost->category->blog_category_name_ban }} @else {{ $blogpost->category->blog_category_name_en }}
                    @endif">
                        @if(session()->get('language') == 'bangla')
                            {{ Str::limit($blogpost->category->blog_category_name_ban,30) }}
                        @else
                            {{ Str::limit($blogpost->category->blog_category_name_en,30) }}
                        @endif
                    </a>
                </li>
                <li class='active'>
                    @if(session()->get('language') == 'bangla')
                        {{ Str::limit($blogpost->post_title_ban,120) }}
                    @else
                        {{ Str::limit($blogpost->post_title_en, 120) }}
                    @endif
                </li>
            </ul>
                                            ...
                                            <a href="{{ url('blog/category/post/'.$category->id) }}">
                                                <li class="list-group-item">
                                                    @if(session()->get('language') == 'hindi')
                                                        {{ $category->blog_category_name_ban }}
                                                    @else
