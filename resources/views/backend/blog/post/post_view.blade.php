                                        ...
                                        <div class="row"> <!-- start 2nd row  -->
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="post_title_en" class="form-control" placeholder="Post title english" required="">
                                                        @error('post_title_en')
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="post_title_ban" class="form-control" placeholder="Post title bangla" required="">
        ...
        function mainThamUrl(input){
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e){
                    $('#mainThmb').attr('src',e.target.result).width(80).height(80).style.objectFit = "cover";
                };
