    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="page-title">Shipped Orders</h3>
                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Shipped Orders List <span class="badge badge-pill badge-primary badge-sm">{{ $total_orders_shipped }}</span></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
