                        ...
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="{{ route('manage-product') }}">Manage Product</a></li>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="form-control"
                                                value="{{ $products['brands']['brand_name_en'] }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="form-control"
                                                value="{{ $products['category']['category_name_en'] }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls mt-3">
                                            <input type="text" class="form-control"
                                                value="{{ $products['subcategory']['subcategory_name_en'] }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls mt-3">
                                            <input type="text" class="form-control"
                                                value="{{ $products['subsubcategory']['subsubcategory_name_en'] }}"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls mt-3">
                                            <input type="text" name="product_name_en" class="form-control"
                                                value="{{ $products->product_name_ban }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls mt-3">
                                            <input type="text" name="product_tags_en" class="form-control"
                                                value="{{ $products->product_tags_en }}" data-role="tagsinput" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls mt-3">
                                            <input type="text" name="product_tags_ban" class="form-control"
                                                value="{{ $products->product_tags_ban }}" data-role="tagsinput" readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls mt-3">
                                            <input type="text" name="product_size_en" class="form-control"
                                                value="{{ $products->product_size_en }}" data-role="tagsinput" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls mt-3">
                                            <input type="text" name="product_size_en" class="form-control"
                                                value="{{ $products->product_size_ban }}" data-role="tagsinput" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls mt-3">
                                            <input type="text" name="product_size_en" class="form-control"
                                                value="{{ $products->product_color_en }}" data-role="tagsinput" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls mt-3">
                                            <input type="text" name="product_size_en" class="form-control"
                                                value="{{ $products->product_color_ban }}" data-role="tagsinput"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls mt-3">
                                            <textarea name="short_descp_en" rows="5" id="textarea" class="form-control" placeholder="Textarea text"
                                                readonly>
                            ...
                            <div class="row">
                                @foreach ($multiImgs as $img)
                                    <div class="col-md-6">
                                        ...
                                        <div class="card">
                                            <img class="img-rounded" src="{{ asset($img->photo_name) }}"
                                                class="card-img-top"
                                                style="height: auto; width: auto; object-fit: cover;">
                                        </div>
