                                    ...
                                    <div class="row row-sm">
                                        @foreach($multiImgs as $img)
                                            <div class="col-md-3">
                                                ...
                                                <div class="card">
                                                    <img src="{{ asset($img->photo_name) }}" class="card-img-top" style="height: auto; width: auto; object-fit: cover;">
                                                    <div class="card-body">
                                                        <h5 class="card-title">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <img src="" id="mainThmb" style="margin-top: 10px; object-fit: cover;">
                                                </div>
                                                </p>
