                                        ...
                                        <div class="row"> <!-- start 4th row  -->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_size_ban" class="form-control" value="Small,Midium,Large" data-role="tagsinput" required>
                                        ...
                                        <div class="row"> <!-- start 5th row  -->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_color_ban" class="form-control" value="red,Black,Large" data-role="tagsinput" required>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                        <img src="" id="mainThmb" alt="" style="object-fit: cover">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row"> <!-- start 8th row  -->
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea id="editor2" name="long_descp_ban" rows="10" cols="80">Long Description Hindi</textarea>
                                                    </div>
                                                </div>
