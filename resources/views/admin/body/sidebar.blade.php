    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @php
                ...
                $returnorder = (auth()->guard('admin')->user()->return_order == 1);
                $review = (auth()->guard('admin')->user()->review == 1);
                $orders = (auth()->guard('admin')->user()->orders == 1);
                $stock = (auth()->guard('admin')->user()->stock == 1);
                $reports = (auth()->guard('admin')->user()->reports == 1);
                $alluser = (auth()->guard('admin')->user()->all_user == 1);
            ...
            @if($brand == true)
                <li class="treeview {{ ($route ==  '/brand') ? 'active':'' }}">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ ($route ==  'brand.edit') ? 'active':'' }}"><a href="#"><i class="ti-more"></i>Brand Edit</a></li>
                    </ul>
                </li>
            @else
            @endif
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ ($route == 'manage-coupon')? 'active':'' }}">
                            <a href="{{ route('manage-coupon') }}">
                                <i class="ti-more"></i>Manage Coupon
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            @if($orders || $stock || $reports || $alluser || !$adminuserrole == false)
            ...
            @if($alluser == true)
                ...
                <li class="treeview {{ ($prefix == '/all-user')?'active':'' }}  ">
                    <a href="#">
